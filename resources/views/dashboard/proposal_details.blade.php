        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @if($project->has_finished)
                    ...
                    @else
                        <span class="text-white font-bold bg-green-500 rounded-2xl w-full p-5">
                            Projek telah selesai, silahkan apply ke projek lain yang masih tersedia
                        </span>
                    @endif
                @else
                    <span class="text-white font-bold bg-cyan-500 rounded-2xl w-full p-5">
                        Projek masih dalam pengembangan, silakan tunggu hingga klien mengundang Anda untuk berdiskusi
                    </span>
                @endif
                        ...
                        <div class="flex flex-row gap-x-4 items-center">
                            ...
                            <div class="flex flex-col">
                                <h3 class="text-indigo-950 text-xl font-bold">
                                    {{$projectApplicant->freelancer->name}}
                                </h3>
                                <p class="text-slate-500 text-sm">
                                    {{$projectApplicant->freelancer->occupation}}
                                </p>
                            </div>
                        </div>
                ...
                <p class="text-slate-500 text-sm">
                    {{$projectApplicant->created_at->format('d M Y H:i')}}
                </p>
                ...
                @if($projectApplicant->status == 'Hired')
                    ...
                    <div class="flex flex-row gap-x-3 items-center">
                        ...
                        <div>
                            <h3 class="text-indigo-950 text-xl font-bold">
                                Income Rp {{number_format($project->budget, 0, ',', '.')}}
                            </h3>
                        <p class="text-slate-500 text-md">
